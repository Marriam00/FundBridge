...
const translations = {
  en: {
    ...
    'hero.title1': 'The Trusted Bridge Between',
    'hero.title2': 'Startups & Strategic Capital.',
    'hero.subtitle': 'Empowering visionary founders with mission-aligned investors through a secure and transparent ecosystem.',
    'hero.btn.startup': 'Raise Funding',
    'hero.btn.bank': 'Join as Investor',
  ...
  ar: {
    ...
    'hero.title1': 'الجسر الموثوق بين',
    'hero.title2': 'الشركات الناشئة ورأس المال.',
    'hero.subtitle': 'تمكين رواد الأعمال الطموحين من خلال ربطهم بمستثمرين استراتيجيين عبر بيئة آمنة وشفافة.',
    'hero.btn.startup': 'احصل على تمويل',
    'hero.btn.bank': 'انضم كمستثمر',
    ...
    'islamic': 'إسلامي',
    'development': 'تنموي',
    'green energy': 'طاقة خضراء',
    'islamic finance': 'تمويل إسلامي',
